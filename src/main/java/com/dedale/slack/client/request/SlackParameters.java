...
class SlackParameters {
    ...
    private static final SlackParameterRequestInjector<Void> NO_INJECT = (request, parameter) -> {
    };
    ...
    public SlackParameters whenNamed(String name, SlackParameterRequestInjector<String> injector) {
    ...
    private <T> SlackParameters addParameter(String name, SlackParameterRequestInjector<T> injector, SlackParameterExtractor<T> extractor) {
